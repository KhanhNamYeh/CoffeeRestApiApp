...
async function fetchMenu() {
    try {
        ...
        menu.forEach(item => {
            ...
            col.className = `col-lg-4 col-md-6 mb-4 ${item.available === "true" ? "" : "opacity-50"}`;
            ...
            <div class="menu-card h-100 shadow-lg">
                ...
                <button class="btn btn-primary w-100 mt-auto" style="background-color: #3d2700;" ${item.available === "true" ? "" : "disabled"} onclick="orderItem('${item.id}')">
                    Order
                </button>
                </div>
            `;
